...
def top():
    machines, err = connect.app_top()
    return render_template('top.html', title='TOP', machines=machines, error_messages=err, email=request.headers.get('X-Forwarded-Email'))
